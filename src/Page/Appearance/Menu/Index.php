...
use Sokeio\Page\Models\MenuItem;
...
class Index extends \Sokeio\Page
{
    ...
    protected function setupUI()
    {
        ...
        return [
            PageUI::make([
                Div::make([])->childWithGroupKey(UIKey::MENU_ADD_ITEM->value)->prefix('formData')->col3(),
                Div::make([
                    Card::make([
                        Div::make([
                ...
                ->rightUI(
                    [
                        ...
                        Button::make()->label('Add Menu')->className('btn btn-primary')
